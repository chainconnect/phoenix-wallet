...
import { LogoWrapper, NavBarWrapper, RightNavWrapper, UserWalletAddress } from './styled';

export default function NavBar() {
  const { publicKey: userWalletAddress } = useGlobalStore((state) => state.appState.account) || {};
